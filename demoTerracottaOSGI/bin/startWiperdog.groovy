    ...
    **/
	...
	public static void main(String[] args) throws Exception {
		...
		try{
			...
			context.installBundle((new File(felix_home + "/" + "lib/java/bundle.a/org.apache.felix.fileinstall-3.0.2.jar")).toURI().toString())
			...
			context.installBundle((new File(felix_home + "/" + "lib/java/bundle.a/ops4j-base-monitors-1.4.0.jar")).toURI().toString())
			context.installBundle((new File(felix_home + "/" + "lib/java/bundle.a/ops4j-base-net-1.4.0.jar")).toURI().toString())
			context.installBundle((new File(felix_home + "/" + "lib/java/bundle.a/ops4j-base-util-property-1.4.0.jar")).toURI().toString())
			context.installBundle((new File(felix_home + "/" + "lib/java/bundle.a/pax-logging-api-1.6.3.jar")).toURI().toString())
			context.installBundle((new File(felix_home + "/" + "lib/java/bundle.a/pax-logging-service-1.6.3.jar")).toURI().toString())
			context.installBundle((new File(felix_home + "/" + "lib/java/bundle.a/pax-swissbox-bnd-1.7.0.jar")).toURI().toString())
			context.installBundle((new File(felix_home + "/" + "lib/java/bundle.a/pax-swissbox-property-1.7.0.jar")).toURI().toString())
			context.installBundle((new File(felix_home + "/" + "lib/java/bundle.a/pax-url-commons-1.6.0.jar")).toURI().toString())
			context.installBundle((new File(felix_home + "/" + "lib/java/bundle.a/pax-url-wrap-1.6.0.jar")).toURI().toString())
